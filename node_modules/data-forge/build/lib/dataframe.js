...
var DataFrame = /** @class */ (function () {
    ...
    DataFrame.initFromIterator = function (iterator) {
        return DataFrame.initFromIterable(new cached_iterator_iterable_1.CachedIteratorIterable(iterator));
    };
    //
    ...
    DataFrame.initFromConfig = function (config) {
        ...
        if (config.columns) {
            ...
            if (DataFrame.isIterator(columnsConfig)) {
                columnsConfig = new cached_iterator_iterable_1.CachedIteratorIterable(columnsConfig);
            }
            ...
            try {
                for (var columnNames_3 = __values(columnNames), columnNames_3_1 = columnNames_3.next(); !columnNames_3_1.done; columnNames_3_1 = columnNames_3.next()) {
                    ...
                    if (DataFrame.isIterator(columnConfig)) {
                        columnConfig = new cached_iterator_iterable_1.CachedIteratorIterable(columnConfig);
                    }
                    else {
            ...
            if (config.columnNames) {
                if (DataFrame.isIterator(config.columnNames)) {
                    columnNames = new cached_iterator_iterable_1.CachedIteratorIterable(config.columnNames);
                }
                else {
            ...
            if (config.rows) {
                ...
                if (DataFrame.isIterator(config.rows)) {
                    rows = new cached_iterator_iterable_1.CachedIteratorIterable(config.rows);
                }
                else {
                    DataFrame.checkIterable(config.rows, 'rows');
                    rows = config.rows;
                }
                values = new csv_rows_iterable_1.CsvRowsIterable(columnNames, rows); // Convert data from rows to columns.
            }
