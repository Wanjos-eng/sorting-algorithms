 ...
 */
function quickSortHelper(arr: number[], low: number, high: number, metrics: SortMetrics): void {
 ...
 */
function partition(arr: number[], low: number, high: number, metrics: SortMetrics): number {
